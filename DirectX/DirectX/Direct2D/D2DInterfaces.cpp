...
void GradientStopCollection::EnsureGradientStops(void)
{
    ...
    if (count > 0)
    {
        _STD vector<D2D1_GRADIENT_STOP> tempStops(count);
...
{
    _STD vector<D2D1_GRADIENT_STOP> gradientStopsVector;
    ID2D1GradientStopCollection * ptr = NULL;
    ...
    )
{
    ...
    _STD vector<D2D1_POINT_2F> pointsVector;
    ...
    )
{
    ...
    _STD vector<D2D1_BEZIER_SEGMENT> beziersVector;
    ...
    )
{
    ...
    _STD vector<D2D1_QUADRATIC_BEZIER_SEGMENT> beziersVector;
    ...
    )
{
    ...
    _STD vector<D2D1_TRIANGLE> trianglesVector;
...
ReadOnlyCollection<Geometry ^>^ GeometryGroup::Geometries::get(void)
{
    ...
    _STD vector<ID2D1Geometry*> sourcesVector(count);
    ...
    )
{
    ...
    _STD vector<ID2D1Geometry*> geometryVector;
